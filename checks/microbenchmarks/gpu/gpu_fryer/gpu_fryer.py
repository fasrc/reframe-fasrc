...
class GPUFryerFP32TensorTest(rfm.RegressionTest):
  ...
  executable = 'timeout -s 9 2m singularity run --nv --bind /usr/lib64/libnvidia-ml.so.1:/usr/lib/x86_64-linux-gnu/libnvidia-ml.so.1 gpu-fryer_1.1.0.sif --use-fp32 60'
